                ...
                <main id="content" class="g5ere__page-main earning-page-main">
                    <div class="container-fluid p-xl-5 p-md-3 p-sm-3">
                        ...
                        <div class="card mb-3 earning-card" style="max-width: 18rem;">
                            <div class="card-header earning-header">Social Earnings</div>
                            <div class="card-body text-dark">
                                <h5 class="card-title">Total Earnings</h5>
								<?php
									global $wpdb;
									$author_id = get_current_user_id();
									$sql = "SELECT SUM(earnings) AS total_earnings FROM wp_pro_earnings WHERE `user_id`=".$author_id." AND `earn_type`='sharing'";
						...
						<h3 class="stats_heading_3">Social Earning Details</h3>
						<div class="table-responsive">
							<table class="table bg-white">
								...
								<tbody>
									...
									global $wpdb;
									$author_id = get_current_user_id();
									$sql = "SELECT * FROM wp_pro_earnings WHERE `user_id`=".$author_id." AND `earn_type`='sharing'";
									$results = $wpdb->get_results($sql);
									if(!empty($results)){
